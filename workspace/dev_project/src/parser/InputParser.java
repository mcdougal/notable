...
public class InputParser {
    ...
    /**
     * Difficulty specification non-terminal. Saves the parsed value to the
     * composition.
     */
    private void difficultySpec() {
        tempString = "";
        
        try {
            whitespace();
            getNextValue(ParserConst.DIFFICULTY_TAG, true);
            whitespace();
            composition.setDifficulty((integer()));
            whitespace();
            ls();
        }
        catch (Exception e) {
